<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <span class="content-name" @click="shopMessageShow = ! shopMessageShow">{{info.name}}</span>
    ...
    <!--这里使用v-if判断info 的数据请求成没有，如果有数据则显示-->
    <div class="shop-header-discounts" v-if="info.supports">
      <div class="discounts-left">
<!--        info 的初始数据是空对象,因为异步显示一开始会报错但请求的数据到了就会显示-->
      ...
      <div class="discounts-right" @click="shopCountShow = !shopCountShow">
        {{info.supports.length}}优惠
      </div>
    </div>
    <div class="shop-brief-modal" v-show="shopMessageShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="shopMessageShow = !shopMessageShow">
          <span class="iconfont icon-chacha"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    <div class="activity-sheet" v-show="shopCountShow">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="shopCountShow = !shopCountShow">
          <span class="iconfont icon-chacha"></span>
        </div>
      </div>
...
<script>
  import {mapState} from 'vuex';
    export default {
      ...
      data(){
        return {
          supportClasses: ['activity-green', 'activity-red', 'activity-orange'], //优惠活动的 类 数组
          shopMessageShow: false, //点击显示商家信息
          shopCountShow: false //点击显示优惠活动
